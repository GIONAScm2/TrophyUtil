...
exports.getPsnpPageTypeKey = exports.getPsnpPageType = exports.PsnpPageType = void 0;
...
exports.getPsnpPageType = getPsnpPageType;
/** Returns the stringified {@link PsnpPageType} */
function getPsnpPageTypeKey(pageType) {
    return (Object.keys(PsnpPageType).find(key => PsnpPageType[key] === pageType) ||
        '');
}
exports.getPsnpPageTypeKey = getPsnpPageTypeKey;
