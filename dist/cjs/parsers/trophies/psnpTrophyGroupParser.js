...
const psnpTrophyParser_js_1 = require("./psnpTrophyParser.js");
class PsnpTrophyGroupParser extends psnpParser_js_1.PsnpParser {
    ...
    _parse(doc) {
        const groups = index_js_1.Select.trophyGroups(doc)
            ...
            const trophyParser = new psnpTrophyParser_js_1.PsnpTrophyParser();
...
//# sourceMappingURL=psnpTrophyGroupParser.js.map