...
const pageType_js_1 = require("./pageType.js");
class Select {
    ...
    static gameNodes = {
        [pageType_js_1.PsnpPageType.Games]: [`#game_list ${Select.SUFFIX}`],
        [pageType_js_1.PsnpPageType.SeriesCatalog]: [`#game_list ${Select.SUFFIX}`],
        [pageType_js_1.PsnpPageType.GameSearch]: [`#search-results:not([style="display: none;"]) ${Select.SUFFIX}`],
        [pageType_js_1.PsnpPageType.Profile]: [
            `#search-results:not([style="display: none;"]) ${Select.SUFFIX}`,
            `#gamesTable:not([style="display: none;"]) ${Select.SUFFIX}`,
        ],
        [pageType_js_1.PsnpPageType.SeriesPage]: [`table.series:not(.legend) ${Select.SUFFIX}`],
        /** Cannot select game nodes on its own; must be used after finding the "OTHER PLATFORMS AND REGIONS" section. */
        [pageType_js_1.PsnpPageType.GameTrophyList]: [`${Select.SUFFIX}`],
    };
}
